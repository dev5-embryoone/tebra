...
export const partnerProgramTypes = [
  ...
  },
  {
    ...
    description:
      "Remain an industry knowledge leader by bringing high-value products to your customer base.",
  ...
  },
  {
    ...
    description:
      "Expand the value of your company by offering an enhanced selection of tools to meet the needs of those you serve.",
    icon: "it" as const,
  },
  {
    key: "billing",
...
export const partnerBenefits = [
  {
    ...
    description:
      "We're fully invested in our partners' success and firmly believe that together, we can unlock better healthcare for everyone.",
    icon: "mutual" as const,
  },
  {
  ...
  {
    title: "Partner hub access",
    description:
      "Our partner hub is your one-stop-shop for partnership tools, resources, and information.",
    icon: "hub" as const,
  },
  {
  ...
  },
  {
    ...
    description:
      "Not only will we help you win new clients, we'll also ensure that their onboarding experience is seamless.",
    icon: "support" as const,
  },
];

export const partnersTestimonialsIntro = {
...
export const partnersTestimonials = [
  {
    quote:
      "We consider Kareo to be more of a business partner rather than a software provider. We could never have grown so quickly without them.",
    author: "Paul Ordonez",
    org: "CEO, Elite Medical Revenue Service",
  },
  {
    quote:
      "Kareo has been the biggest driving factor in my growth and in fact we've grown over 125%, revenue-wise, over the last 18 months.",
    author: "Katie Fergus",
    org: "CEO, PractiSynergy",
  },
];
...
export const partnersProcessSteps = [
  {
    ...
    description:
      "To get things started, we'll align on goals and outcomes tailored to your specific needs.",
  },
  {
    num: "02",
    title: "Personalized onboarding",
    description:
      "Next, you'll be matched with a committed team who will provide all the resources you need for success.",
  },
  {
    num: "03",
  ...
  },
  {
    ...
    description:
      "Together, we'll work consistently to optimize your path toward continued success.",
  },
];
