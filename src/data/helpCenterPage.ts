...
export const helpCenterResourceColumns: Array<{
...
}> = [
  {
    ...
    links: [
      { label: "Tebra University", href: "/documentation", external: true },
      { label: "Professional Services", href: "/implementation", external: true },
      { label: "Release Notes", href: "/newsroom", external: true },
      { label: "User Guides", href: "/guides", external: true },
      { label: "Tebra Videos", href: "/webinars", external: true },
    ],
  },
  {
    title: "Quick Links",
    ...
    links: [
      { label: "Getting Started", href: "/independent-practices", external: true },
      { label: "Download PM", href: "/billing-payments", external: true },
      { label: "Claim Rejections", href: "/billing-payments/electronic-claim-submission", external: true },
      { label: "System Status", href: "/support", external: true },
      { label: "API / Integration", href: "/integrations", external: true },
    ],
  },
  {
    ...
    footerLink: { label: "Learn More", href: "/for-billing-companies", external: true },
  },
  {
    title: "CMS Incentive Programs",
    headerClass: "bg-[#D1D9D9]",
    links: [
      { label: "MACRA", href: "/compliance", external: true },
      { label: "Quality Measures", href: "/reporting", external: true },
      { label: "Training Videos", href: "/webinars", external: true },
      { label: "Additional Resources", href: "/resources", external: true },
    ],
  },
] as const;
